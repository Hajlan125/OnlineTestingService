<template>
	<div class="wrapper fadeInDown">
		<b-button @click="$router.push({name: 'home'})">Вернуться</b-button>
		<div id="formContent">
			<!-- Tabs Titles -->
			...
			<div class="fadeIn first">
				<b-icon icon="person-bounding-box" style="height: 100px; width: 100px"></b-icon>
			</div>
		...
		<b-alert
			...
			@dismissed="isNeedToShow=false">Неправильный логин и/или пароль</b-alert>
	</div>
</template>
